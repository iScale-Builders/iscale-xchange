...
export function ExploreHeroCard({
  ...
  return (
    ...
    >
            ...
            return (
              ...
              >
                <img
                  ...
                  aria-hidden="true"
                  fetchPriority="low"
                  className="absolute inset-0 h-full w-full scale-110 object-cover opacity-25 blur-2xl dark:opacity-45"
                />
      ...
      {/* legibility scrim — a caption bar at the bottom (works in both themes) */}
