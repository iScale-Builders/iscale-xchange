...
export default async function BlogArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const articleJsonLd = {
    ...
    dateModified: article[0].updatedAt.toISOString(),
    mainEntityOfPage: `${siteUrl}/blog/${slug}`,
    keywords: tags?.join(", "),
    image: article[0].image ? [`${siteUrl}${article[0].image}`] : undefined,
  }
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-10">
          ...
          <div className="lg:col-span-7">
            <article>
              ...
              {/* Article Content */}
              <div className="foundry-panel prose dark:prose-invert [&_img]:border-border [&_table]:border-border [&_tbody_tr:hover]:bg-muted [&_td]:border-border [&_th]:border-border [&_thead]:bg-muted max-w-none rounded-2xl p-6 [&_img]:mx-auto [&_img]:rounded-lg [&_img]:border [&_img]:md:max-w-3xl [&_table]:my-8 [&_table]:w-full [&_table]:border-collapse [&_table]:overflow-hidden [&_table]:rounded-lg [&_table]:border [&_tbody_tr:last-child_td]:border-b-0 [&_td]:border-r [&_td]:border-b [&_td]:px-4 [&_td]:py-3 [&_td]:align-middle [&_td]:text-sm [&_td:last-child]:border-r-0 [&_th]:border-r [&_th]:border-b [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_th]:align-middle [&_th]:text-sm [&_th]:font-bold">
                <MDXRemote
                  source={content}
                  options={{
                    mdxOptions: {
          ...
          <div className="lg:col-span-3">
            <div className="sticky top-20 space-y-4">
              ...
              {/* CTA Card */}
              <div className="foundry-panel rounded-2xl p-4">
                  ...
                  <DialogContent className="max-h-[90vh] max-w-md overflow-y-auto sm:max-w-lg">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div className="flex gap-3">
                            <div className="bg-primary text-primary-foreground flex h-5 w-5 flex-shrink-0 items-center justify-center rounded text-xs font-medium">
                              1
                            </div>
