...
function NoWinnersFound() {
  return (
    <div className="foundry-panel mx-3 rounded-2xl p-8 text-center sm:mx-4">
      <div className="border-border bg-muted mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border shadow-[0_0_24px_rgb(34_211_238_/_0.18)]">
        <RiTrophyFill className="text-foreground h-6 w-6" />
      </div>
      <h3 className="mb-2 text-lg font-black text-white">No winners found</h3>
...
export default async function WinnersPage({
  ...
  return (
    <main className="foundry-page min-h-screen">
      <div className="foundry-container">
        <div className="scroll-live mb-8">
          <p className="foundry-kicker">Daily leaderboard</p>
          ...
          <div className="md:col-span-2">
            <div className="mb-6">
              <div className="mb-6 flex items-center justify-between">
                <h2 className="px-3 text-xl font-black text-white sm:px-4 sm:text-2xl">
                  Winners archive
                </h2>
              </div>

              <div className="foundry-panel mx-3 rounded-2xl p-4 sm:mx-4">
