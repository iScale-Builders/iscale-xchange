          ...
          <div className="flex h-full flex-col p-6 md:col-span-5">
            ...
            <div className="mt-auto pt-3">
              <Button variant="outline" size="lg" className="w-full" asChild>
                <Link
                  href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL}?subject=Weekly%20Sponsorship%20Inquiry`}
                >
                  Sponsor for a Week
                </Link>
              </Button>
          ...
          <div className="bg-muted/50 flex h-full flex-col border-t p-6 md:col-span-5 md:border-t-0 md:border-l">
            ...
            <div className="mt-auto pt-3">
              <Button size="lg" className="w-full" asChild>
                <Link
                  href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL}?subject=Monthly%20Sponsorship%20Inquiry`}
                >
                  Sponsor for a Month
                </Link>
              </Button>
